...
public final class p extends d3.g implements j3.p {
    ...
    public final /* synthetic */ String f1837r;
    public final /* synthetic */ K s;

    /* renamed from: t, reason: collision with root package name */
    public final /* synthetic */ k3.p f1838t;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public p(String str, K k4, k3.p pVar, InterfaceC0190d interfaceC0190d) {
    ...
    public final InterfaceC0190d g(InterfaceC0190d interfaceC0190d, Object obj) {
        return new p(this.f1837r, this.s, this.f1838t, interfaceC0190d);
    }
    ...
    public final Object k(Object obj) {
        ...
        if (i4 == 0) {
            ...
            M.d dVar = new M.d(this.f1837r);
            Context context = this.s.f1788l;
            if (context == null) {
                k3.h.i("context");
                throw null;
            }
            C0079o c0079o = new C0079o(((InterfaceC0039h) L.a(context).f1009m).d(), dVar, 0);
            k3.p pVar2 = this.f1838t;
            this.f1835p = pVar2;
            this.f1836q = 1;
