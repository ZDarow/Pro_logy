...
public final class C0392e extends ScanCallback {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ C0395h f7059a;

    public C0392e(C0395h c0395h) {
        this.f7059a = c0395h;
    }

    @Override // android.bluetooth.le.ScanCallback
    public final void onScanFailed(int i4) {
        String str = "onScanFailed: " + C0395h.m(i4);
        C0395h c0395h = this.f7059a;
        c0395h.C(str, 2);
        ...
        hashMap.put("error_string", C0395h.m(i4));
        c0395h.z("OnScanResponse", hashMap);
    }
    ...
    */
    public final void onScanResult(int r18, android.bluetooth.le.ScanResult r19) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: k2.C0392e.onScanResult(int, android.bluetooth.le.ScanResult):void");
    }
}
