...
public final class g extends C0015b {
    @Override // C.C0015b
    ...
    public final void b(View view, D.f fVar) {
        ...
        if (nestedScrollView.getScrollY() > 0) {
            accessibilityNodeInfo.addAction((AccessibilityNodeInfo.AccessibilityAction) D.c.f412d.f415a);
            accessibilityNodeInfo.addAction((AccessibilityNodeInfo.AccessibilityAction) D.c.f413e.f415a);
        }
        if (nestedScrollView.getScrollY() < scrollRange) {
            accessibilityNodeInfo.addAction((AccessibilityNodeInfo.AccessibilityAction) D.c.f411c.f415a);
            accessibilityNodeInfo.addAction((AccessibilityNodeInfo.AccessibilityAction) D.c.f414f.f415a);
        }
    }
