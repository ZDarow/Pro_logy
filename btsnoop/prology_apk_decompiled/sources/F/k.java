...
public final class k implements ActionMode.Callback {
    ...
    public final ActionMode.Callback f566a;
    ...
    public final boolean onActionItemClicked(ActionMode actionMode, MenuItem menuItem) {
        return this.f566a.onActionItemClicked(actionMode, menuItem);
    }

    @Override // android.view.ActionMode.Callback
    public final boolean onCreateActionMode(ActionMode actionMode, Menu menu) {
        return this.f566a.onCreateActionMode(actionMode, menu);
    }

    @Override // android.view.ActionMode.Callback
    public final void onDestroyActionMode(ActionMode actionMode) {
        this.f566a.onDestroyActionMode(actionMode);
    }
    ...
    public final boolean onPrepareActionMode(ActionMode actionMode, Menu menu) {
        ...
        if (!this.f571f) {
            ...
            try {
                ...
                this.f568c = cls;
                this.f569d = cls.getDeclaredMethod("removeItemAt", Integer.TYPE);
                this.f570e = true;
        ...
        try {
            Method declaredMethod = (this.f570e && this.f568c.isInstance(menu)) ? this.f569d : menu.getClass().getDeclaredMethod("removeItemAt", Integer.TYPE);
        ...
        return this.f566a.onPrepareActionMode(actionMode, menu);
    }
}
