...
public final class C0361p extends ImageButton {

    /* renamed from: l, reason: collision with root package name */
    public final C0359n f6729l;

    /* renamed from: m, reason: collision with root package name */
    public final Y.x f6730m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0361p(Context context) {
        super(context, null, R.attr.toolbarNavigationButtonStyle);
        k0.a(context);
        j0.a(this, getContext());
        C0359n c0359n = new C0359n(this);
        this.f6729l = c0359n;
        c0359n.b(null, R.attr.toolbarNavigationButtonStyle);
        Y.x xVar = new Y.x(15, this);
        this.f6730m = xVar;
        xVar.T(R.attr.toolbarNavigationButtonStyle);
    }

    @Override // android.widget.ImageView, android.view.View
    public final void drawableStateChanged() {
        super.drawableStateChanged();
        C0359n c0359n = this.f6729l;
        if (c0359n != null) {
            c0359n.a();
        }
        Y.x xVar = this.f6730m;
        if (xVar != null) {
            xVar.M();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        return !(((ImageView) this.f6730m.f3065m).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering();
    }
